...
const ids = [
  ...
  'motionState', 'chipTemp', 'chipState', 'adcVoltage', 'adcState', 'heapFree', 'heapState', 'persistedCount',
  ...
  'camBrightness', 'camContrast', 'camSaturation', 'camSharpness', 'camSpecialEffect',
  'camWbMode', 'camAwb', 'camAwbGain', 'camAec', 'camAec2', 'camAeLevel',
  'camAecValue', 'camAgc', 'camAgcGain', 'camGainCeiling', 'camMirror', 'camVflip',
  'camColorbar', 'regPreset', 'regPresetBtn', 'regDevice', 'regAddr', 'regMask', 'regValue',
  ...
  'headphoneVolumeBtn', 'allVolumeControl', 'allVolumeBtn', 'peripheralState', 'cpuMhzControl',
  'cpuMhzBtn', 'wifiPowerControl', 'wifiPowerBtn', 'configState', 'cfgTempHigh', 'cfgHumidityHigh', 'cfgSoundHigh',
